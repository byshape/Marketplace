...
task("balances20", "Prints the account balance")
...
task("allowances20", "Prints the account allowance")
.addParam("contract", "ERC20 address", undefined, types.string)
...
task("transfer20", "Transfers tokens to address")
.addParam("contract", "ERC20 address", undefined, types.string)
.addParam("to", "Recipient address", undefined, types.string)
.addParam("value", "Amount to transfer", undefined, types.string)
.setAction(async (taskArgs, hre) => {
    let erc20 = await getContract(taskArgs.contract, hre);
...
task("approve20", "Approves tokens to address")
.addParam("contract", "ERC20 address", undefined, types.string)
.addParam("to", "Spender address", undefined, types.string)
.addParam("value", "Amount to approve", undefined, types.string)
.setAction(async (taskArgs, hre) => {
    let erc20 = await getContract(taskArgs.contract, hre);
...
task("transferFrom20", "Transfers approved tokens to address")
.addParam("contract", "ERC20 address", undefined, types.string)
...
task("mint20", "Mints tokens to address")
.addParam("contract", "ERC20 address", undefined, types.string)
.addParam("to", "Recipient address", undefined, types.string)
